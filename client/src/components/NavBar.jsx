...
import { AppBar, Box, Button, Toolbar, useMediaQuery, IconButton } from "@mui/material"
import { Link, useNavigate } from 'react-router-dom'
import { Menu as MenuIcon } from "@mui/icons-material"
import Menu from '@mui/material/Menu';
import MenuItem from '@mui/material/MenuItem';
import { AuthContext } from '../App.js';
// import image from "../images/desktop-wallpaper-marvel-backgrounds-for-pc-laptop-avengers-thumbnail.jpg"
                        ...
                        <>
                            {auth ?
                                <>
                                    ...
                                    <Button><Link style={{ color: "#fff", textDecoration: "none" }} to={"/create"}>Post</Link></Button>
                        ...
                        : <>
                            ...
                            >
                                {auth ? [
                                    ...
                                    <MenuItem onClick={handleClose}><Link style={{ color: "#333", textDecoration: "none" }} to={"/create"}>Post</Link></MenuItem>,
